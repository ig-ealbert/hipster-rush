...
This is a card game that I came up with based on the idea of not doing what everyone else is doing.
...
While you may want to play high cards to get more points, so will everyone else!

The first player to 50 points is the winner.

## Installation

You only need to install the game once.
